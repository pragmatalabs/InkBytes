...
def config(storage_type="local"):
    ...
    outlets_folder = os.path.join(base_system_folder, os.getenv("OFFLINE_OUTLETS_FOLDER"))
...
BACKOFFICE_API_URL = os.getenv("STRAPI_API_BASE_URL", "")
...
NER_TYPES = {
    ...
    'EVENT': 'Refers to real-world detectors, such as natural disasters or sports matches.',
