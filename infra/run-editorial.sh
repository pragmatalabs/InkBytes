...
exec docker run --rm --network "$NETWORK" \
  ...
  -e EDITORIAL_COVERS_ENABLED="${EDITORIAL_COVERS_ENABLED:-true}" \
  -e EDITORIAL_COVERS_MONTHLY_CAP_USD="${EDITORIAL_COVERS_MONTHLY_CAP_USD:-10}" \
  -e EDITORIAL_COVERS_QUALITY="${EDITORIAL_COVERS_QUALITY:-low}" \
