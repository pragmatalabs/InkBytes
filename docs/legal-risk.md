...
- [ ] **M1 — Stop displaying unlicensed source images** *(kills L3, ~1 day)*. Drop the `og:image` hero, OR switch to own/licensed/CC/AI imagery. Engineering: stop populating `articles.lead_image` rollup in the Reader hero / Curator `/events` rollup.
