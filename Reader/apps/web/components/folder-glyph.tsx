 ...
 * Set `color` on a parent to theme the border. Faithful geometry (viewBox
 * 512×400); the carousel overlays the icon / count / name on the front body.
 */
export default function FolderGlyph({ className }: { className?: string }) {
  return (
    <svg viewBox="0 0 512 400" className={className} role="img" aria-hidden="true"
      ...
      <path
        d="M62.22,81.21h380.72c27.66,0,50.09,19.47,50.09,43.48v226.1c0,24.01-22.43,43.48-50.09,43.48H62.22c-27.66,0-50.09-19.47-50.09-43.48V124.69c0-24.01,22.43-43.48,50.09-43.48Z"
        fill="#ffffff" stroke="currentColor" strokeWidth="6" strokeLinejoin="round" />
    </svg>
  );
}
