...
function StreamingIcon() {
  // Stage 5: dropped the two off-palette ping rings (#6A6493 / #FC4442) and the
  // per-path fills in those same colours — they existed nowhere else in the app.
  // The glyph now inherits the palette via currentColor.
  return (
    <span className="relative inline-flex flex-none items-center justify-center w-5 h-5 text-[var(--accent)]">
      <svg className="relative w-5 h-5" viewBox="0 0 64 64" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
        <path d="M54.364,52.952h-1.603v-2.167h1.603c1.423,0,2.582-1.158,2.582-2.582V15.796c0-1.424-1.158-2.582-2.582-2.582H9.636c-1.424,0-2.582,1.158-2.582,2.582v2.056H4.887v-2.056c0-2.618,2.131-4.749,4.749-4.749h44.728c2.618,0,4.748,2.131,4.748,4.749v32.407C59.113,50.822,56.983,52.952,54.364,52.952z"/>
        <path d="M59.251,48.065h-1.602v-2.167h1.602c1.424,0,2.582-1.158,2.582-2.582V10.909c0-1.423-1.158-2.582-2.582-2.582H14.524c-1.424,0-2.582,1.158,2.582,2.582v2.056H9.775v-2.056c0-2.618,2.131-4.748,4.749-4.748h44.727C61.869,6.16,64,8.29,64,10.909v32.407C64,45.934,61.869,48.065,59.251,48.065z"/>
        <path d="M49.893,57.84H4.333C1.944,57.84,0,55.896,0,53.507V20.268c0-2.389,1.944-4.333,4.333-4.333h45.559c2.389,0,4.333,1.944,4.333,4.333v33.239C54.226,55.896,52.282,57.84,49.893,57.84z M4.333,18.101c-1.195,0-2.167,0.972-2.167,2.167v33.239c0,1.195,0.972,2.167,2.167,2.167h45.559c1.195,0,2.167-0.972,2.167-2.167V20.268c0-1.195-0.972-2.167-2.167-2.167H4.333z"/>
